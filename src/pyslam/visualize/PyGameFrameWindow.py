...
from pyslam.capture.common.monocular_uncalibrated_camera.MonocularUncalibratedCameraMeasurement import MonocularUncalibratedCameraMeasurement
...
class PyGameFrameWindow:
    ...
    def __init__(self, msgQueue: MessageQueue[Image]):
        ...
        self.loopProcess : Optional[multiprocessing.Process] = None
    ...
    def __captureLoop(self) -> None:
        ...
        while True:
            ...
            queueResult: Optional[
                Image
            ] = self.msgQueue.listen(block=True, timeout=-1)
            ...
            if self.pygameSurface is None:
                ...
                self.pygameSurface = pygame.display.set_mode((xDim, yDim))
            ...
            self.pygameSurface.blit(pygameImage, self.pygameSurface.get_rect())
            pygame.display.flip()
    ...
    def startListenLoop(self):
        ...
        with self.lock:
            if self.loopProcess is not None:
                ...
                self.loopProcess = multiprocessing.Process(target=self.__captureLoop)
